...
void main() {
  final AndroidActivityLifecyclePlatform initialPlatform = AndroidActivityLifecyclePlatform.instance;

  test('$MethodChannelAndroidActivityLifecycle is the default instance', () {
    expect(initialPlatform, isInstanceOf<MethodChannelAndroidActivityLifecycle>());
  });

  test('getPlatformVersion', () async {
    AndroidActivityLifecycle androidActivityLifecyclePlugin = AndroidActivityLifecycle();
    MockAndroidActivityLifecyclePlatform fakePlatform = MockAndroidActivityLifecyclePlatform();
